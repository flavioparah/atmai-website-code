   ...
   export default function HomePage() {                                                                                  
     const cases = [                                                                                                     
       {                                                                                                                 
         name: "Charles",                                                                                                
         company: "Moage Café",                                                                                          
         role: "Barista Virtual",                                                                                        
         description: "Hospitalidade absoluta e consultoria especializada em café.",                                     
         image: "/images/charles.jpeg",                                                                                  
         href: "https://www.instagram.com/p/DT-Vh5oDYk3/",                                                               
       },                                                                                                                
       {                                                                                                                 
         name: "Chef Dasa",                                                                                              
         company: "Govinda",                                                                                             
         ...
         <main>                                                                                                          
           ...
           <ManifestoSection initialVisible>                                                                             
             <div className="text-center px-4 relative">                                                                 
               <h1 className="font-serif text-[5.5rem] leading-[0.9] sm:text-8xl md:text-[11rem] mb-6 md:mb-10           
 tracking-[0.1em] md:tracking-[0.2em] text-foreground">                                                                  
                 Atm<span className="text-gold">AI</span>                                                                
               </h1>                                                                                                     
                                                                                                                         
               {/* Texto forçado em uma única linha */}                                                                  
               <p className="whitespace-nowrap inline-block relative left-1/2 -translate-x-1/2 text-[10px] md:text-xl    
 font-light opacity-60 tracking-[0.3em] md:tracking-[0.5em] uppercase text-foreground">                                  
 ...
 href="https://wa.me/559192250381?text=Ol%C3%A1%2C%20quero%20iniciar%20a%20g%C3%AAnese%20da%20minha%20AtmAI"             
           ...
           <ManifestoSection>                                                                                            
             <div className="max-w-4xl px-4 md:px-6 text-right ml-auto">                                                 
               ...
               <p className="text-base md:text-xl font-light opacity-80 leading-relaxed ml-auto max-w-2xl                
 text-foreground">                                                                                                       
           ...
           <ManifestoSection>                                                                                            
             <div className="max-w-7xl w-full px-4 md:px-6">                                                             
               <div className="mb-12">                                                                                   
                 ...
                 <p className="text-base md:text-xl font-light opacity-80 leading-relaxed max-w-4xl mb-10                
 text-foreground">                                                                                                       
                   ...
                   negócio. É a génese de uma entidade digital com corpo e mente da sua marca, seu novo ativo de         
 marketing. Opera{" "}                                                                                                   
