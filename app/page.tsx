        ...
        <section className="min-h-[60vh] flex flex-col items-center justify-center pt-20 pb-0">
          <ManifestoSection initialVisible>
            <div className="flex flex-col items-center text-center px-4 relative z-10">
              <h1 className="font-serif text-[5.5rem] leading-[0.9] sm:text-8xl md:text-[11rem] mb-4 md:mb-6           
   tracking-[0.1em] md:tracking-[0.2em] text-foreground">
                Atm<span className="text-gold">AI</span>
              </h1>

              <p className="whitespace-nowrap inline-block text-[10px] md:text-xl    
   font-light opacity-60 tracking-[0.3em] md:tracking-[0.5em] uppercase text-foreground mb-4">
        ...
        {/* Spirit Path (Bola Brilhante) */}
        <div className="relative h-5 w-full overflow-visible z-20">
            <SpiritOverlay />
        </div>

        {/* Primeiro Botão (CTA) - Texto atualizado para "Inicie sua AtmAI" */}
